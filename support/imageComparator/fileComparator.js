...
console.log("comparator starts");
  var compareFiles = function (path1, path2) {
    var data1 = readImg(path1);
      console.log("data1 finished: ", data1.length);
    var data2 = readImg(path2);
      console.log("data2 finished: ", data2.length);
